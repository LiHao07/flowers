...
parser.add_argument('--batches', type=int, default=5*25, metavar='N')
...
scheduler = optim.lr_scheduler.LambdaLR(optimizer, lambda epoch: math.pow(1-epoch/args.batches, 1.2))
