...
parser.add_argument('--random_seed', type=int, default=1, metavar='N')
parser.add_argument('--batches', type=int, default=20*27, metavar='N')
...
weight = {k: v for k, v in weight.items() if (k[:10]!='classifier' and k[9:11]!='17' and k[9:11]!='16' and
                                              k[9:11] != '15' and k[9:11]!='14' and k[9:11]!='13'
                                              and k[9:11] != '12' and k[9:11]!='11' and k[:4]!='conv')}
#print(weight.keys())
...
scheduler = optim.lr_scheduler.LambdaLR(optimizer, lambda epoch: math.pow(1-epoch/args.batches, 1.5))
